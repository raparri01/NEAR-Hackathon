...
export const averagePriceMockData = generateAveragePriceMockData(thirtyDays)
...
export const volatilityMockData = generateAveragePriceMockData(thirtyDays)
...
export const volumeMockData = generateVolumeMockData(thirtyDays)
...
export const uniqueBuyersMockData = generateVolumeMockData(thirtyDays)
